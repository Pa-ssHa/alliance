...
@Entity
@Table(name = "feedback_coursework")
public class FeedbackCoursework implements Feedback {
    ...
    public FeedbackCoursework() {}

    public FeedbackCoursework(String text, Date dateOfPlacement, User user, int rating, boolean isAnon, boolean isActive) {
        this.text = text;
